...
gasp = gasp.group_by(["Country", "year"]).agg(
    pl.sum("Azithromycin_num_resistant"),
    pl.sum("Azithromycin_num_tested"),
    pl.sum("Cefixime_num_resistant"),
    pl.sum("Cefixime_num_tested"),
    pl.sum("Ciprofloxacin_num_resistant"),
    pl.sum("Ciprofloxacin_num_tested"),
    pl.sum("Ceftriaxone_num_resistant"),
    pl.sum("Ceftriaxone_num_tested"),
)
