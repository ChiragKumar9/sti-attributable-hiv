...
countries_to_exclude = ["LBR", "GNQ", "STP", "SOM"]
...
dhs_treatment_seeking = (
    dhs_treatment_seeking.group_by("region", "sex")
    .agg(
        symptom_treat_seek_rate=pl.sum("n_sought_treatment")
        / pl.sum("n_sti_respondents"),
    )
